...
class Settore(models.Model):
    nome = models.CharField("Nome Settore", max_length=255, unique=True)
...
class Event(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        logger.info(f"Saving Event: {self.titolo} (ID: {self.id})")
...
class EventFile(models.Model):
    ...
    def save(self, *args, **kwargs):
        ...
        import logging
        logger = logging.getLogger(__name__)
        logger.info(f"Saving EventFile: {self.title} (Event: {self.event.titolo})")
